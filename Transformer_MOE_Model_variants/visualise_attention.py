...
# print(len(tokens_src), len(tokens_tgt))
# print(len(decoder_cross_attns))
# print(len(decoder_cross_attns[0]))
# print(len(decoder_cross_attns[0][0]))
# print(len(decoder_cross_attns[0][0][0]))
#Plot decoder cross-attention (layer 0)
plot_attention(decoder_cross_attns,1, 1,tokens_src, tokens_tgt, "Decoder Cross Attention (Layer 1, Head 1)")

# Plot decoder self-attention (layer 0)
# plot_attention(decoder_self_attns[0], tokens_tgt, tokens_tgt, "Decoder Self Attention (Layer 0)")

# # Plot encoder self-attention (layer 0)
# plot_attention(encoder_attns[0], tokens_src, tokens_src, "Encoder Self Attention (Layer 0)")