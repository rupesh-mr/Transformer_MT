...
if __name__ == "__main__":
    ...
    bidirectional_csv_file = "bidirectional_eng_mtei.csv"
    create_bidirectional_csv(csv_file, "bidirectional_eng_mtei.csv", "src", "tgt", src_lang_token="<2mni>", tgt_lang_token="<2en>") 
    dataset = TranslationDataset(csv_file,"sentencepiece/eng_spm.model","sentencepiece/mtei_spm.model","src", "tgt", cache_file='tokenized_dataset.pt')
    ...
    valid_dataset = TranslationDataset("dev.csv", "sentencepiece/eng_spm.model","sentencepiece/mtei_spm.model", "src", "tgt", cache_file='tokenized_valid_dataset.pt')
    ...
    model = TransformerModel(
        src_vocab_size=8000,  # Adjust based on your SentencePiece vocab size #chnages 32k to 8k
        tgt_vocab_size=8000,  # Adjust based on your SentencePiece vocab size
        d_model=512,
        nhead=8,
